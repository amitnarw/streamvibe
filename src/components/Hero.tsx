  ...
  return (
    <div className="relative">
      <section className="relative overflow-hidden pt-24 h-screen min-h-140 flex flex-col">
        ...
        {/* Central big icon */}
        <div className="absolute top-4/12 sm:top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none drop-shadow-2xl scale-75 md:scale-95 lg:scale-125">
          <motion.div
      ...
      {/* Text content */}
      <div className="absolute top-7/12 sm:top-160 left-1/2 -translate-x-1/2 text-center px-3 md:px-8 pb-12 md:pb-20 z-30 flex flex-col items-center w-full">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={{
